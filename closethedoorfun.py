                    ...
                    try:
                        ...
                        if device.close_allowed:
                            if device.state == STATE_CLOSED:
                                ...
                                try:
                                    close_task = await device.open(wait_for_state=False)
                            ...
                            print(f"Closing of garage door {device.name} is not allowed.")
        ...
        async with ClientSession() as websession:
            try:
                ...
                for account in api.accounts.values():
                    ...
                    print(c.FAIL + "[myq api] " + c.WARNING + f"Successfully Closed Braden's Garage Doors.")
